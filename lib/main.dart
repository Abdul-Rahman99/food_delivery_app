...
import 'package:food_delivery/services/recommendations.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
        ...
        child: ChangeNotifierProvider<FoodNotifier>(
    ...
    children: <Widget>[
      ...
      Expanded(
        child: TextButton(
          child: Text(
            'Recommendations',
            style: TextStyle(fontFamily: 'free', fontSize: 40),
          ),
          onPressed: () => {},
        ),
      ),
  ...
  GestureDetector buildGestureDetector(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Color.fromARGB(175, 33, 150, 243),
            borderRadius: BorderRadius.circular(50)),
      ),
    );
  }
